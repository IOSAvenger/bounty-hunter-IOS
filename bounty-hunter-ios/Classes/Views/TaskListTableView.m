...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.TitleList = @[@"习近平看望儿童：精忠报国是我一生目标",@"李克强：打通金融服务实体经济的“血脉”",@"解放军副总长脱稿批安倍：你有话不妨直说",@"招远血案受害人：原计划换班陪6岁儿子过六一",@"广州一楼盘突然大幅降价 老业主阻止售楼"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil)
    {
        ...
        UIView *bottomview = [[UIView alloc] initWithFrame:CGRectMake(10, 80, 300, 30)];
        ...
        UITextView *description = [[UITextView alloc] initWithFrame:CGRectMake(10, 30, 200, 60)];
        [description setBackgroundColor:[UIColor blueColor]];
